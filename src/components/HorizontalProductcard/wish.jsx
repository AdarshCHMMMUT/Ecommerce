                    ...
                    <div className="card-details d-flex direction-column">
                         ...
                         <div className="cta-btn d-flex gap">
                              <div className="cta-btn">
                                   <button onClick={() => onRemovewish(product)} className="button hori-btn btn-primary btn-icon d- flex align-center justify-center gap cursor btn-margin">
                                        <FavoriteIcon /> Remove from wishList</button>
                              </div>
